...
# create scores file for training set
with open(output_dir + 'scores-training.csv', mode='w', newline='') as scores_file:
...
# create scores file for test set
with open(output_dir + 'scores-test.csv', mode='w', newline='') as scores_file:
    scores_writer = csv.writer(scores_file, delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    scores_writer.writerow(['match', 'round', 'ct', 'terrorists'])
