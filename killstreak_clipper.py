...
for i in range(3, 4):
    ...
    if 5 in sorted_kill_streak_list:
        for killstreak in sorted_kill_streak_list[5]:
            print('Looking for 5-Killstreak in match ' + str(i) + '. Begin of match at ' + util.sec_to_timestamp(stream_begin_sec))
            ...
            if util.timestamp_to_sec(str(killstreak_duration)) < max_killstreak_length:
                start_pos_in_video_sec = stream_begin_sec + util.timestamp_to_sec(str(difference_between_match_begin_and_killstreak_begin))
                ...
                cut_video_within_boundaries(video_full_name, killstreak_begin_sec - clipping_offset_sec,
                                            killstreak_begin_sec + util.timestamp_to_sec(str(killstreak_duration)) + clipping_offset_sec,
